...
class fcx_Before_After {
  constructor($obj = null) {
    ...
    this.$el = {
      $wrap: $obj,
      $before: jQuery(
        '<div class="fcx-before-after-img fcx-before-img"/>'
      ).appendTo($obj),
      $after: jQuery(
        '<div class="fcx-before-after-img fcx-after-img-wrap"/>'
      ).appendTo($obj),
      $divider: jQuery(
...
class fcx_Mobile_Menu {
  constructor($obj) {
    ...
    this.$overlay = jQuery('<div class="fcx-mobile-menu-overlay"/>').appendTo(
      this.$body
    );
...
class fcx_Infinite_List {
    ...
    this.$el
      .on("mouseenter", ".fcx-infinite-list-item", function () {
        ...
        if ("video" === $preview.attr("data-type")) {
          jQuery(this)
            .children(".fcx-infinite-list-preview")
            .children("video")[0]
            .play();
  ...
  init() {
    ...
    this.$bg_wrap = jQuery('<div class="fcx-infinite-list-bgs"/>').appendTo(
      this.$el
    );
    this.$scroll = jQuery('<div class="fcx-infinite-scroll"/>').appendTo(
      this.$el
    );
    this.$cloned_list = jQuery(
      '<div class="fcx-infinite-scroll-inner"/>'
...
class fcx_LWP {
  constructor($obj = null) {
    ...
    this.$media = jQuery(
      '<div class="fcx-lwp-media" data-appear="fade-right"/>'
    ).prependTo(this.$el);
